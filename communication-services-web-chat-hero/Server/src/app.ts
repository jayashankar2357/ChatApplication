...
import getGroupChatId from './routes/getGroupChatId';
import getGroupNames from './routes/getGroupNames';
 ...
 * purpose: Chat,Calling: get the endpoint url of ACS resource
 */
app.use('/getGroupChatId', cors(), getGroupChatId);

/**
 * route: /getGroupNames
 * purpose: Chat,Calling: get the Group Names from JSON
 */
app.use('/getGroupNames', cors(), getGroupNames);
